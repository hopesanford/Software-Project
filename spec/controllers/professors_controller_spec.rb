  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved professor as @professor" do
        ...
        post :create, {:professor => { "name" => "invalid value" }}, valid_session
        assigns(:professor).should be_a_new(Professor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested professor" do
        ...
        Professor.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => professor.to_param, :professor => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the professor as @professor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Professor.any_instance.stub(:save).and_return(false)
        put :update, {:id => professor.to_param, :professor => { "name" => "invalid value" }}, valid_session
        assigns(:professor).should eq(professor)
      end
